...
import BirdSprite1 from '../sprites/BirdSprite1';
import BirdSprite2 from '../sprites/BirdSprite2';
...
export const SpriteImage = ({ spriteName, styles, handleClick }) => {
    switch (spriteName) {
        ...
        case "bird1":
            return <BirdSprite1 styles={styles} onClick={handleClick} />
        case "bird2":
            return <BirdSprite2 styles={styles} onClick={handleClick} />
        default:
            return <></>
    }
}
